...
public class MultiListener extends JPanel {
    ...
    public MultiListener() {
        ...
        Hearer hearsAll = new Hearer(topTextArea);

        button1.addActionListener(hearsAll);
        button2.addActionListener(hearsAll);
...
class Hearer implements ActionListener {
    JTextArea myTextArea;

    public Hearer(JTextArea ta){
        myTextArea = ta;
    }
